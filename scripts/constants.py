...
config = parse_yaml("../config/suturing_all.yaml")
...
WEIGHT_EXPERT = config["WEIGHT_EXPERT"]

WEIGHT_INTERMEDIATE = config["WEIGHT_INTERMEDIATE"]

WEIGHTED_PRUNING_MODE = config["WEIGHTED_PRUNING_MODE"]
